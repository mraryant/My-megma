...
// ********** this code is for    page2  scroll typing effect****************
const Page2 = () => {
    let content = "";

    document.querySelector("#page2-in>h1").textContent.split("").forEach((element) => {
        content += `<span>${element}</span>`;
    });
    document.querySelector("#page2-in>h1").innerHTML = content;


    gsap.to("#page2-in>h1>span ", {

        scrollTrigger: {
            trigger: "#page2-in>h1>span",
            scroller: "#main",
            // markers: true,
            start: "top 80%",
            end: "top 40%",
...
// ********** this code is for    page4 scroll typing effect****************
const Page4 = () => {
    let content2 = "";
    document.querySelector("#page4-in>h1").textContent.split("").forEach((elem) => {
        content2 += `<span>${elem}</span>`;
    })
    document.querySelector("#page4-in>h1").innerHTML = content2;

    gsap.from("#P4-h1>span", {
...
const Page6 = () => {
    let content2 = "";
    document.querySelector("#page6>h1").textContent.split("").forEach((elem) => {
        content2 += `<span>${elem}</span>`;
    })
    document.querySelector("#page6>h1").innerHTML = content2;
